...
export class FormCompraAccionComponent implements OnInit {
  ...
  compraPost: CompraDTO = { nombre: this.accionSelec.descripcion, simbolo: this.accionSelec.simbolo, comision: this.comisionEstablecida, cantidad: this.cantidadCompra, precio: this.accionSelec.ultimoPrecio, idCliente: 999314, fecha: "fechaDeHoy" }
